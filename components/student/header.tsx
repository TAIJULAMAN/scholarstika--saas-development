...
import { SidebarContent } from "@/components/student/sidebar"
    ...
    return (
        <header className="flex h-16 items-center justify-between border-b bg-gradient-to-r from-[#16A34A] via-[#4BD17C] to-[#FACC15] px-4 md:px-6">
            <div className="flex items-center gap-3">
                ...
                <h1 className="text-lg md:text-xl font-semibold text-white">Student Dashboard</h1>
            </div>
            ...
            <div className="flex items-center gap-2 md:gap-4">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="hidden flex-col md:flex">
                        <span className="text-sm font-semibold text-white">Alex Thompson</span>
                        <span className="text-xs text-white/80">Grade 11 Student</span>
                    </div>
                </div>
            </div>
        </header>
