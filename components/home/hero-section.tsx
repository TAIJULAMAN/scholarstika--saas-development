      ...
      <div className="relative z-10 container mx-auto grid gap-8 px-4 py-12 sm:px-6 md:grid-cols-2 md:gap-10 md:py-16 lg:px-12">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="mb-6 text-sm leading-relaxed text-[#1e3a5f]/80 sm:mb-8 sm:text-base md:text-xl">
            Scholarstika is a modern cloud-based school management platform that
            helps schools manage academics, administration, communication
            between school staff, parents & students, fee tracking, reporting,
            school clinic visits, school income & expenditure, and all other
            day-to-day operations from one connected system. Built for both web
            and mobile use, it supports single schools, multi-branch schools,
            and growing education networks.
          </p>
          ...
          <ul className="mb-6 space-y-2 sm:mb-8 sm:space-y-3">
            ...
            <li className="flex items-center gap-2 sm:gap-3">
              ...
              <span className="text-xs font-medium text-[#1e3a5f] sm:text-sm md:text-xl">
                Role-based access for every key user.
              </span>
            </li>
            <li className="flex items-center gap-2 sm:gap-3">
              <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-amber-500 sm:h-8 sm:w-8">
              ...
              <span className="text-xs font-medium text-[#1e3a5f] sm:text-sm md:text-xl">
                Secure cloud-based access on web and mobile.
              </span>
            </li>
            <li className="flex items-center gap-2 sm:gap-3">
              <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-amber-500 sm:h-8 sm:w-8">
        ...
        <div className="flex items-center justify-center">
          <div className="relative w-full max-w-sm overflow-hidden rounded-2xl bg-white p-2 shadow-2xl md:max-w-xl sm:rounded-3xl sm:p-3 md:max-w-lg">
