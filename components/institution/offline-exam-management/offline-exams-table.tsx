                    ...
                    <table className="w-full">
                        <thead style={{ backgroundColor: 'rgba(16, 185, 129, 0.8)' }} className="rounded-t-lg">
                            <tr>
                                ...
                                <th className="whitespace-nowrap pb-3 pt-3 text-left text-sm font-semibold text-white min-w-[150px]">Date & Time</th>
                                <th className="whitespace-nowrap pb-3 pt-3 text-left text-sm font-semibold text-white min-w-[150px]">Venue</th>
                                <th className="whitespace-nowrap pb-3 pt-3 text-left text-sm font-semibold text-white min-w-[80px]">Marks</th>
                                <th className="whitespace-nowrap pb-3 pt-3 text-left text-sm font-semibold text-white min-w-[100px]">Students</th>
                        ...
                        <tbody>
                            {currentExams.map((exam) => (
                                <tr key={exam.id} className="border-b border-gray-100 transition-colors hover:bg-gray-50">
                                    ...
                                    <td className="whitespace-nowrap py-6 text-sm text-gray-700"><div>{exam.examDate}</div><div className="text-xs text-gray-500">{exam.examTime}</div></td>
                                    <td className="whitespace-nowrap py-6 text-sm text-gray-700">{exam.venue}</td>
                                    <td className="whitespace-nowrap py-6 text-sm font-semibold text-gray-900">{exam.totalMarks}</td>
                                    <td className="whitespace-nowrap py-6 text-sm font-semibold text-gray-900">{exam.students}</td>
