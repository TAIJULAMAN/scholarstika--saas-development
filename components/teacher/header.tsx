    ...
    return (
        <header className="flex h-16 items-center justify-between border-b bg-gradient-to-r from-[#16A34A] via-[#4BD17C] to-[#FACC15] px-4 md:px-6">
            <div className="flex items-center gap-3">
                ...
                <h1 className="text-lg md:text-xl font-semibold text-white">Teacher Dashboard</h1>
            </div>
                ...
                <div className="flex items-center gap-3">
                    <Link href="/teacher/profile">
                        <Avatar className="h-8 w-8 md:h-9 md:w-9 border-2 border-white">
                            ...
                            <AvatarFallback className="bg-white text-emerald-600">TC</AvatarFallback>
                        </Avatar>
                    </Link>
                    <div className="hidden flex-col md:flex">
                        <span className="text-sm font-semibold text-white">Sarah Johnson</span>
                        <span className="text-xs text-white/80">Mathematics Teacher</span>
                    </div>
                </div>
            </div>
        </header>
