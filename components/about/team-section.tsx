        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div className="group rounded-2xl bg-white p-6 shadow-md transition-all hover:shadow-xl">
            ...
            <div className="flex gap-2">
              <a
                href="#"
                className="flex h-8 w-8 items-center justify-center rounded bg-purple-100 text-purple-600 hover:bg-purple-200"
              >
                <svg
                  className="h-4 w-4"
                  fill="currentColor"
          ...
          <div className="group rounded-2xl bg-white p-6 shadow-md transition-all hover:shadow-xl">
            ...
            <div className="flex gap-2">
              <a
                href="#"
                className="flex h-8 w-8 items-center justify-center rounded bg-blue-100 text-blue-600 hover:bg-blue-200"
              >
                <svg
                  className="h-4 w-4"
                  fill="currentColor"
          ...
          <div className="group rounded-2xl bg-white p-6 shadow-md transition-all hover:shadow-xl">
            ...
            <div className="flex gap-2">
              <a
                href="#"
                className="flex h-8 w-8 items-center justify-center rounded bg-emerald-100 text-emerald-600 hover:bg-emerald-200"
              >
                <svg
                  className="h-4 w-4"
                  fill="currentColor"
          ...
          <div className="group rounded-2xl bg-white p-6 shadow-md transition-all hover:shadow-xl">
            ...
            <p className="mb-3 text-sm text-gray-600">Educator</p>
            <div className="flex gap-2">
              <a
                href="#"
                className="flex h-8 w-8 items-center justify-center rounded bg-amber-100 text-amber-600 hover:bg-amber-200"
              >
                <svg
                  className="h-4 w-4"
                  fill="currentColor"
