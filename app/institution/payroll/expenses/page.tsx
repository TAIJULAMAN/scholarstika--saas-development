...
import { ViewExpenseDialog } from "@/components/bursar/reports/expenses/view-expense-dialog"
import { EditExpenseDialog } from "@/components/bursar/reports/expenses/edit-expense-dialog"
import { DeleteExpenseDialog } from "@/components/bursar/reports/expenses/delete-expense-dialog"
        ...
        <div className="space-y-6">
            ...
            <div className="rounded-xl bg-white p-6 shadow-sm">
                <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
                    <h2 className="text-lg font-semibold text-gray-900">Payroll Expenses</h2>
